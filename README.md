...
- **[implement](./skills/engineering/implement/SKILL.md)** — Implement a piece of work based on a PRD or set of issues, using `/tdd` at pre-agreed seams and reviewing the result.
...
- **[resolving-merge-conflicts](./skills/engineering/resolving-merge-conflicts/SKILL.md)** — Resolve an in-progress git merge/rebase conflict: recover each side's intent, resolve every hunk, run the project's checks, finish the merge.
